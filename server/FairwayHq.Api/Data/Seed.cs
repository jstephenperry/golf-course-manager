...
public static class Seed
{
    public static void EnsureSeeded(AppDbContext db)
    {
        ...
        db.Members.AddRange(
            new Member { Id = "mbr_J4nKp2vQ8x", FirstName = "Eleanor", LastName = "Park", Email = "eleanor.park@example.com", Phone = "555-0142", Tier = "Full", Handicap = 8.4, JoinDate = "2019-03-12", Active = true, Balance = 0m },
